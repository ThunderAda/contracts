...
contract ThunderAda is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public toBurnThunderBnbAddress = 0xb9654A42f0F5dCDEf5617DebF8bd048E33F180E7;
    uint256 public toBurnThunderBnbFee = 2;
    ...
    constructor() ERC20("ThunderADA.app", "THUNDERADA") {
    ...
    function updateBurnThunderCakeAddress(address _newAddress) external onlyOwner {
        toBurnThunderBnbAddress = _newAddress;
    }
    ...
    function _updateTotalFee() internal {
        totalFees = buyBackAndLiquidityFee.add(marketingFee).add(a80DividendRewardsFee).add(b20DividendRewardsFee).add(toBurnThunderBnbFee);
    }
    ...
    function useBnbToBurnThunderBnb(uint256 amount) private {
        ...
        path[1] = toBurnThunderBnbAddress;
    ...
    function buyBackThunderBnbAndBurn(uint256 amount) private {
        ...
        path[2] = toBurnThunderBnbAddress;
